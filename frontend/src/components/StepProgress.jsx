    ...
    return (
        <>
           ...
           border border-white/10  '>
                ...
                {/*MAIN PROGRESS BAR*/}
                <div className='relative h-full bg-gradient-to-r from-violet-500 via-fuchsia-600
               ...
               animate-pulse-glow ' style={{ width: `${progress}%` }}>
                ...
                animate-shimmer'/>
                    ...
                    <div className='absolute inset-0 opacity-80'>
                        {[...Array(8)].map((_, i) => (
                            <div key={i} className='absloute top-1/2 w-2 h-2 bg-white rounded-full animate-bubble shadow-lg'
                                style={{
                                    left: `${(i + 1) * 12}%`,
                ...
                {progress > 0 && (
                    ...
                    via-white/50 to-white/30 blur-sm ' style={{
