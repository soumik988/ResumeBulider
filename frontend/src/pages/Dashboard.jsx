...
import CreateResumeFrom from '../components/CreateResumeFrom'
        ...
        {!loading && allResumes.length === 0 && (
          <div className={styles.emptyStateWrapper}>
            ...
            <p className={styles.emptyText}>
              You have not created any resumes yet. Start building your professional resume to land your
              dream job.
            </p>
            <button className={styles.createButton} onClick={() => setOpenCreateModal(true)}>
              <div className={styles.createButtonOverlay}></div>
      ...
      <Modal isOpen={openCreateModal} onClose={() => setOpenCreateModal(false)} hideHeader maxWidth='max-w-2xl'>
        <div className='p-6'>
          <div className={styles.modalHeader}>
            ...
            <button onClick={() => setOpenCreateMoal(false)} className={styles.modalCloseButton}>X</button>
          </div>
          <CreateResumeFrom onSuccess={() => { setOpenCreateModal(false); fetchAllResumes(); }} />
        </div>
      </Modal>
