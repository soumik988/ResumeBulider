...
import { ArrowRight, LayoutTemplate, Menu, X, Zap, Download, LampWallDown } from "lucide-react"
              ...
              <div className={landingPageStyles.statsContainer}>
                {[
                  ...
                  <div className={landingPageStyles.statItem} key={idx}>
                    <div
                      className={`${landingPageStyles.statNumber} ${stats.gradient}`}
                    >
                      {stats.value}
                    </div>
            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                ...
                <p className={landingPageStyles.ctaDescription}>
                  Join Thousands of professionals who landed their dream jobs with our platfrom
